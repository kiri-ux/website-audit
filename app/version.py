...
BUILD = "2026.08.20-93"
BUILD_NOTES = ("The AI panel carries forward from the audit that ran it, "
               "the review count covers three stars and below, and a "
               "promise we cannot keep now fails the tests")
